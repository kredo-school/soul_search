<a href="#" class="text-decoration-none ms-2">
    <img src="{{ asset('images/logo.svg')}}" class="m-3 ms-2 hide-992">
    <img src="{{ asset('images/logo-s.svg')}}" class="mt-3 show-992">
</a>
    ...
    @if ( !request()->is('*profile*') && !request()->is('*message*') && !request()->is('*search*') && !request()->is('*contact*') && !request()->is('*passwords*'))
        <li class="nav-item py-2 sidebar-selected fw-bold">
            <a href="{{ route('index') }}" class="flex-fill nav-link link-dark">
                ...
                <span class="text-dark ms-2 hide-992">Home</span>
            </a>
        </li>
    @else
    ...
    @if ( request()->is('*profile*') || request()->is('*passwords*'))
        <li class="nav-item py-2 sidebar-selected fw-bold">
            <a href="{{ route('profiles.index') }}" class="flex-fill nav-link link-dark">
                ...
                <span class="text-dark ms-2 hide-992">My Profile</span>
            </a>
        </li>
    @else
        <li class="nav-item py-2">
    ...
    @if ( request()->is('*message*'))
        <li class="nav-item py-2 sidebar-selected fw-bold">
            <a href="{{ route('messages.show', ['user' => Auth::id()]) }}" class="flex-fill nav-link link-dark">
                ...
                <span class="text-dark ms-2 hide-992">Message</span>
            </a>
        </li>
    @else
        <li class="nav-item py-2">
    ...
    @if ( request()->is('*search*'))
        <li class="nav-item py-2 sidebar-selected fw-bold">
            <a href="{{ route('search.index') }}" class="flex-fill nav-link link-dark">
                ...
                <span class="text-dark ms-2 hide-992">Search</span>
            </a>
        </li>
    @else
        <li class="nav-item py-2">
    ...
    @if ( request()->is('*contact*'))
        <li class="nav-item py-2 sidebar-selected fw-bold">
            <a href="{{ route('contact.index') }}" class="flex-fill nav-link link-dark">
                ...
                <span class="text-dark ms-2 hide-992">Contact Us</span>
            </a>
        </li>
    @else
        <li class="nav-item py-2">
