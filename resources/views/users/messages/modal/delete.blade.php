    ...
    <div class="modal-dialog">
        <div class="modal-content modal-menu">
            ...
            <div class="modal-body">
                ...
                <div>
                    @if($both_data)
                        <form action="{{ route('messages.update', ['user' => $user->id, 'message' => $id]) }}" method="post" class="d-inline">
                            @csrf
                            @method('PATCH')
                    ...
                    @else
                        <form action="{{ route('messages.destroy', ['user' => $user->id, 'message' => $id]) }}" method="post" class="d-inline">
                            @csrf
                            @method('DELETE')
                    @endif
