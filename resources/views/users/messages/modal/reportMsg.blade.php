{{-- report user modal --}}
<div class="modal fade" id="reportMsgModal{{$chat->id}}" tabindex="-1" aria-labelledby="reportMsgModal{{$chat->id}}Label" aria-hidden="true">
	<div class="modal-dialog">
		<div class="modal-content modal-menu">
			<div class="modal-header">
				<h2 class="modal-title" id="reportMsgModal{{$chat->id}}">Report Message</h2>
			</div>
			<div class="modal-body">
                ...
                <div>
                    <form action="#" method="post">
                        @csrf
                        <input type="hidden" value="{{ $chat->id }}" name="message_id">
