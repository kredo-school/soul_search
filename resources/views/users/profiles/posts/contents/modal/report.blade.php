			...
			<div class="modal-body">
                ...
                <div>
                    <form action="{{ route('reports.store') }}" method="post">
                        ...
                        <div class="mb-2">
                            <input type="radio" class="form-check-input" id="comms" name="violation_types" value="communication">
                        ...
                        <div class="mb-2">
                            <input type="radio" class="form-check-input" id="names" name="violation_types" value="name">
                        ...
                        <div class="mb-3">
                            <input type="radio" class="form-check-input" id="threats" name="violation_types" value="threat">
